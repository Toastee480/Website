...
[ "posts/2022-06-07-A-Beginners-Guide-to-Piracy.html", encodeURI('A Beginner\'s Guide to Piracy' ) ],
[ "posts/2022-06-05-What-is-This.html", encodeURI('What is This?') ]];
...
if ( postsArray.length < 2 ) {
  ...
  nextprevHTML = '<a href="' + relativePath + '/'+ prevlink +'">\u00AB Previous Post</a> | <a href="' + relativePath + '/index.html">Home</a>';
} else if ( currentIndex === postsArray.length - 1 ) {
  nextlink = postsArray[currentIndex - 1][0];
  nextprevHTML = '<a href="' + relativePath + '/index.html">Home</a> | <a href="' + relativePath + '/'+ nextlink +'">Next Post \u00BB</a>';
} else if ( 0 < currentIndex && currentIndex < postsArray.length - 1 ) {
  nextlink = postsArray[currentIndex - 1][0];
  prevlink = postsArray[currentIndex + 1][0];
  nextprevHTML = '<a href="' + relativePath + '/'+ prevlink +'">\u00AB Previous Post</a> | <a href="' + relativePath + '/index.html">Home</a> | <a href="' + relativePath + '/'+ nextlink +'">Next Post \u00BB</a>';
}
